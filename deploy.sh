...
echo ""
echo -e "          🌿 \033[1;42m如需验证合约（将合约开源），请参考以下指南\033[0m🌿"
echo -e "  \033[1;34m┌─────────────────────────────────────────────────────────────┐\033[0m"
echo -e "  \033[1;34m│\033[0m \033[1;35m📄 CONTRACT_VERIFICATION_GUIDE.md\033[0m"
echo -e "  \033[1;34m└─────────────────────────────────────────────────────────────┘\033[0m"
echo ""
echo -e "          🌿 \033[1;42m合约部署已完成！可使用以下方法运行批量交易\033[0m🌿"
echo -e "  \033[1;34m┌─────────────────────────────────────────────────────────────┐\033[0m"
echo -e "  \033[1;34m│\033[0m \033[1;33m🔄️ 运行标准批量交易:\033[0m \033[1;32mnode src/standard-batch.js\033[0m"
echo -e "  \033[1;34m│\033[0m \033[1;33m🔄️ 运行Hex批量交易:\033[0m \033[1;32mnode src/hex-batch.js\033[0m"
echo -e "  \033[1;34m└─────────────────────────────────────────────────────────────┘\033[0m"
echo ""